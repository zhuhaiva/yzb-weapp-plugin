...
// 根据手机号查询美团团购券
export function queryMeituanProductByMobile({ mobile, dealGroupId, dealId }) {
  return request({
...
// 美团在线核销
export function verifyMeituan({ phone, code, count, roomCode }) {
  return request({
...
// 抖音核销团购券
export function verifyDouYin({ phone, code, roomCode }) {
  return request({
