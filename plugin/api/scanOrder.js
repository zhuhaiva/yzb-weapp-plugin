...
export function getpayinfoAPI(islock = false, data) {
  const url = islock
    ? "littleapp/customerservice/lock/getpayinfo.do"
    : "littleapp/customerservice/getpayinfo.do";
  return request({
    url,
    header: {
      "content-Type": "application/x-www-form-urlencoded",
...
export function payAPI(islock = false, data) {
  const url = islock
    ? "littleapp/customerservice/lock/pay.do"
    : "littleapp/customerservice/pay.do";
  return request({
    url,
    method: "POST",
    header: {
...
export function paythebillAPI(islock = false, data) {
  const url = islock
    ? "littleapp/customerservice/lock/paythebill.do"
    : "littleapp/customerservice/paythebill.do";
  return request({
    url,
    method: "POST",
    header: {
